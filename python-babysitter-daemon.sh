...
### BEGIN INIT INFO
# Provides:           python-babysitter
# Required-Start:     $syslog $remote_fs
# Required-Stop:      $syslog $remote_fs
# Default-Start:      2 3 4 5
# Default-Stop:       0 1 6
# Short-Description:  Python babysitter starts and stops python using slave script
### END INIT INFO

BASE=python-babysitter
BINARY=/home/pi/mock-dispenserslave.sh
# CONFIG=/z/deploy/${BASE}.config
CHUIDARG="pi:pi" # <== Unpriviliged user
...
case "$1" in
	...
	restart|force-reload)
		...
		sleep 5; # Give script some time to stop containers
		$0 start
		;;
